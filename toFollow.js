        ...
        onFrameUpdate: function() {
            ...
            if (window.playing && window.snake !== null) {
                ...
                if (window.goalCoordinates) {
                    ...
                    slitherApp.database().ref("slither/x").set(window.snake.xx);
                    slitherApp.database().ref("slither/y").set(window.snake.yy);
                ...
                if (window.bso !== undefined && userInterface.overlays.serverOverlay.innerHTML !==
                    ...
                    slitherApp.database().ref("slither/address").set(window.bso.ip + ':' + window.bso.po);
